...
```
docker build -t docker.io/burrsutter/hybrid-cloud-backend:1.0.0 -f src/main/docker/Dockerfile.jvm .
docker push docker.io/burrsutter/hybrid-cloud-backend:1.0.0
```